...
# Network Analysis of Systemic Financial Risk 🏦📊
===

# 

# Este proyecto utiliza \*\*Ciencia de Datos y Teoría de Grafos\*\* para analizar la interconexión entre deudores y entidades financieras. El objetivo es identificar riesgos sistémicos, triangulación de fondos y exposición multientidad mediante una visualización interactiva.
